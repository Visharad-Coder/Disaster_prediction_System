    ...
    <style>
        * {
        ...
        body {
            ...
            background-image: url(https://live.staticflickr.com/5057/5518626289_d18a4322cb_b.jpg);
...
<div class="wrapper">
    <div class="login_box">
        ...
        <p class="card-text" >An earthquake (also known as a quake, tremor or temblor) is the shaking of the surface of the Earth resulting from a
            sudden release of energy in the Earth's lithosphere that creates seismic waves.</p><br>
        <p>On 6 February 2023, at 04:17 TRT (01:17 UTC), a Mw 7.8 earthquake struck southern and central Turkey and northern and
            western Syria. An estimated 14 million people, or 16 percent of Turkey's population, were affected.</p>
        <div class="input_box">
        ...
        <script>
            function redirectToEarthquakeLocation() {
                ...
                window.location.href = "earthquake_location";
            }
        </script>
    </div>
</div>
