...
<div class="wrapper">
    <div class="login_box">
        <form action="user-form-flood" method="post" <%-- onsubmit="return redirectToEarthquakeLocation()">--%>>
            <div class="login-header">
                <span>Flood</span>
            </div>
            <div class="input_box">
                <label for="location_earthquake">Location</label>
                <select id="location_earthquake" name="location_earthquake">
                    <c:forEach var="doc" items="${cities}">
