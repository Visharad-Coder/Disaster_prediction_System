    ...
    <style>
        * {
        ...
        body {
            ...
            background-image: url('https://www.indiaspend.com/h-upload/2022/10/08/810256-landslides1500.jpg');
...
<div class="wrapper">
    <div class="login_box">
        ...
        <p class="card-text" >Landslides, also known as landslips, are several forms of mass
            wasting that may include a wide range of ground movements, such as rockfalls, mudflows, shallow
            or deep-seated slope failures and debris flows.</p><br>
        <p> On the night of July 19, Irshalwadi village was wiped out, and in its place stands a huge
            mound of earth that once formed the now-barren hillside. Only 142 of the 228 residents
            survived.</p>
        <div class="input_box">
        ...
        <script>
            function redirectToEarthquakeLocation() {
                ...
                window.location.href = "landslide_location";
            }
        </script>
    </div>
</div>
