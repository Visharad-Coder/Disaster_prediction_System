    ...
    <style>
        * {
        ...
        body {
            ...
            background-image: url('https://akm-img-a-in.tosshub.com/sites/visualstory/wp/2023/07/image-836.png?size=*:900');
...
<div class="wrapper">
    <div class="login_box">
        ...
        <p class="card-text" >A flood is an overflow of water that submerges land
            ...
            saturated ground in an areal flood</p><br>
        <p> On 16 August 2018, severe floods affected the south Indian state Kerala, over 483 people died, and 15 went missing.</p>
        <div class="input_box">
        ...
        <script>
            function redirectToEarthquakeLocation() {
                ...
                window.location.href = "flood_location";
            }
        </script>
    </div>
</div>
